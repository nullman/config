(custom-set-variables
 ...
 '(replacer-replacements
   '(("h" . replacer-help)
     ...
     ("obpe" . org-insert-literate-programming-project-euler-problem-block)) nil nil "Customized with use-package replacer")
 '(replacer-trigger-end " " nil nil "Customized with use-package replacer")
 '(replacer-trigger-start ";" nil nil "Customized with use-package replacer")
