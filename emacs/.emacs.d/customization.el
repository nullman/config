(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-mode ht forge ghub treepy closql emacsql-sqlite emacsql counsel-projectile ivy-prescient prescient wgrep flx ivy-hydra ivy-rich counsel helpful elisp-refs dash-functional multiple-cursors vimish-fold lua-mode doom-modeline shrink-path all-the-icons memoize calendar-remind ox ob-python ob-java org-src command-log-mode ob-shell swiper-helm swiper xterm-color transient dash js2-mode inf-ruby flycheck company bind-key async beacon quelpa yasnippet-snippets xref-js2 wttrin wtf which-key weblogger web-query w3m undo-tree switch-window sudoku split-move spinner sokoban smex slime simple-mpc robe replacer regex-tool quelpa-use-package python-mode ps-ccrypt projectile powerline popwin plantuml-mode pivotal-tracker persistent-scratch org-pdfview openwith omni-quotes ob-kotlin ob-ipython ob-async neotree mingus material-theme markdown-mode magit-popup magit ledger-mode langtool kotlin-mode keyfreq key-chord json-mode js2-refactor js-comint jedi ivy ini-mode ini iedit hydra hungry-delete htmlize helm graphviz-dot-mode gnuplot geiser fuzzy flymake-cursor flycheck-kotlin flatland-theme expand-region erlang epoch eperiodic elpy elpher elnode elisp-slime-nav elfeed easy-kill dired-single diminish demo-it define-word decimation cycle-buffer centered-cursor-mode browse-kill-ring brainfuck boxquote bbdb basic bash-completion avy auto-menu auto-compile anzu any-ini-mode analog-clock alert aggressive-indent ag)))
(custom-set-faces
