...
;; [[file:init-emacs.org::*Global Variables][Global Variables:5]]
...
;; [[file:init-emacs.org::*Buffers and Windows][Buffers and Windows:3]]
  ...
  (when (string= mode-name "Org")
    (let ((sort-types (or sort-types
                          (if (and (org-entry-get nil "TODO")
                            ...
                            '((nil . ?a))))))
      (save-mark-and-excursion
        (if (equal (car (org-element-at-point)) 'headline)
            (progn
              (condition-case nil
...
;; [[file:init-emacs.org::*langtool][langtool:1]]
;;------------------------------------------------------------------------------
;;; Modules: langtool
;;------------------------------------------------------------------------------
...
;; [[file:init-emacs.org::*Snippets][Snippets:1]]
;;==============================================================================
;;; Snippets
;;==============================================================================
